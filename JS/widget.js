const questions = {
    "1": {
    "text": 'Ознакомьтесь с основными направлениями развития современных технологий обслуживания. Основными направлениями развития современных технологий обслуживания в ресторанах, барах и кафе являются: <br>Cоздание концептуальных предприятий общественного питания; <br>Расширение сети виртуальных ресторанов, обеспечивающих прием заказа по сети Интернет и доставку его потребителю; <br>Приготовление блюд в присутствии посетителей;<br> Организация обслуживания по системе кейтеринг; <br>Внедрение мерчандайзинга (сбыта продукции и услуг).',
    "type": "step",
    "img_path": "image/1.jpg",
    },
    "2": {
    "text": 'Ознакомьтесь более подробно с перечисленными выше основными направлениями развития технологий обслуживания. Концептуальным называется ресторан, в котором интерьер оформлен в национальном или экзотическом стиле, а в меню возможно смешение кухонь и стилей. Идея концептуального ресторана включает выбор предпринимателем определенной темы, в соответствии с которой разрабатывается меню, оформляется интерьер, выбираются поставщики оборудования, посуды, приборов, продуктов, напитков. В качестве темы может быть использован кинематографический, исторический, литературный или другой сюжет, легенда. Избранная тема предусматривает, например, создание ресторана – кабаре, трактира или клуба. Виртуальным называется ресторан, в котором осуществляется прием заказа по сети Интернет и доставка его потребителю. Основной потребитель страничек в Интернете – предполагаемый потребитель ресторана. Он может не только ознакомиться с информацией, отправить и получить сообщение, но и поговорить с менеджером ресторана и даже видеть его в момент разговора. Потребитель может не только заказать столик в ресторане, но и оплатить его, введя номер счета или кредитной карты.',
    "type": "step",
    ...
    "7": {
    "text": 'Ознакомьтесь с основными элементами обслуживания в ресторане. Обслуживание в ресторане складывается из следующих элементов:<br> • Встреча гостей, размещение их в зале;<br> • Предложение меню и карты вин, аперитива;<br>• Рекомендации в выборе закусок, блюд, напитков; <br>• Прием, оформление и уточнение заказа;<br> • Передача заказа на производство; <br>• Досервировка стола в соответствии с принятым заказом;<br> • Подача напитков, закусок и блюд; <br>• Расчет с гостями.',
    "type": "step",
